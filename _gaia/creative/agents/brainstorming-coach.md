...
<menu-handlers>
  <handler cmd="1" action="workflow" path="core/workflows/brainstorming/workflow.yaml" />
  <handler cmd="2" action="workflow" path="core/workflows/party-mode/workflow.yaml" />
</menu-handlers>
...
<menu>
  <item cmd="1" label="Brainstorming Session" description="Facilitated creative brainstorming" workflow="core/workflows/brainstorming/workflow.yaml" />
  <item cmd="2" label="Party Mode" description="Multi-agent group discussion" workflow="core/workflows/party-mode/workflow.yaml" />
</menu>
