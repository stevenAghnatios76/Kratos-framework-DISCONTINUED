...
<menu>
  <item cmd="1" label="Brainstorm Project" description="Brainstorm a new project idea" workflow="lifecycle/workflows/1-analysis/brainstorm-project/workflow.yaml" command="kratos-brainstorm" />
  <item cmd="2" label="Market Research" description="Conduct market and competitive research" workflow="lifecycle/workflows/1-analysis/market-research/workflow.yaml" command="kratos-market-research" />
  <item cmd="3" label="Domain Research" description="Research a domain or industry" workflow="lifecycle/workflows/1-analysis/domain-research/workflow.yaml" command="kratos-domain-research" />
  <item cmd="4" label="Technical Research" description="Research technologies and architecture" workflow="lifecycle/workflows/1-analysis/technical-research/workflow.yaml" command="kratos-tech-research" />
  <item cmd="5" label="Create Product Brief" description="Create product brief through discovery" workflow="lifecycle/workflows/1-analysis/create-product-brief/workflow.yaml" command="kratos-product-brief" />
  <item cmd="6" label="Document Project" description="Document an existing project" workflow="lifecycle/workflows/anytime/document-project/workflow.yaml" command="kratos-document-project" />
  <item cmd="7" label="Generate Project Context" description="Generate AI-optimized context" workflow="lifecycle/workflows/anytime/generate-project-context/workflow.yaml" command="kratos-project-context" />
</menu>
