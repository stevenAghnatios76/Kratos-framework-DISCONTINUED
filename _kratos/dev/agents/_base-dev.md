...
## Checkpoint Writing
- After each subtask: write checkpoint to `_kratos/_memory/checkpoints/`
...
<skill-registry>
  <skill name="git-workflow" path="_kratos/dev/skills/git-workflow.md" />
  <skill name="api-design" path="_kratos/dev/skills/api-design.md" />
  <skill name="database-design" path="_kratos/dev/skills/database-design.md" />
  <skill name="docker-workflow" path="_kratos/dev/skills/docker-workflow.md" />
  <skill name="testing-patterns" path="_kratos/dev/skills/testing-patterns.md" />
  <skill name="code-review-standards" path="_kratos/dev/skills/code-review-standards.md" />
  <skill name="documentation-standards" path="_kratos/dev/skills/documentation-standards.md" />
  <skill name="security-basics" path="_kratos/dev/skills/security-basics.md" />
</skill-registry>
